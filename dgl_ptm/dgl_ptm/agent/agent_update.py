...
def agent_update(model_graph, model_params, timestep=None, method='default'):
    ...
    '''
    if method == 'capital':
        capital_update(model_graph, model_params, timestep, method=model_params['capital_update'])
    elif method == 'theta':
        agent_perception_update(model_graph, model_params, timestep, method=model_params['perception_update'])
