...
git branch -M main
git remote add origin git@github.com:SDCCA/dgl_ptm
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/SDCCA/repositories/new](https://github.com/organizations/SDCCA/repositories/new)
and create a new repository named `dgl_ptm` as an empty repository, then push your commits to GitHub:
...
automatically ([here](git@github.com:SDCCA/dgl_ptm/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
